...
<?php $etudiant = $demande->etudiant; ?>
    ...
    <div class="title">ATTESTATION DE POURSUIVI</div>
    <div class="content">
        ...
        <p>
            A Poursuivi ses études à la faculté au titre de l’année universitaire :
            <b>{{ date('Y')-1 }}/{{ date('Y') }}</b>
        </p>
        <p>
            Filière : <b>{{ $demande->etudiant->filiere }}</b>
        </p>
        <p>
    ...
    <div class="footer">
        <p style="text-align:right">Oujda, le : <b>{{ date('d/m/Y') }}</b></p>
        <p>
            <b>LE DOYEN</b>
        </p>
